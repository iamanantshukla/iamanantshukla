...
// Controlled tag vocabulary (retrieval layer). No emoji — plain words. Daily-state tags (§4.7) so
// logging is taps not typing, plus the higher-signal event tags the reviews lean on.
const TAG_VOCAB = [
  'slept well', 'caffeine', 'focused', 'stressed', 'sore', 'travel', 'kit change',
  'competition', 'illness', 'PR', 'deload', 'breakthrough', 'rest',
];
          ...
          {loading ? <p>Loading...</p> : (
            <div className="jr-shell">
              ...
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '4px' }}>
                ...
                {/* Agent-trigger affordance is local-only (sub-project B §3.3.4); hidden on pages. */}
                {IS_LOCAL && (
